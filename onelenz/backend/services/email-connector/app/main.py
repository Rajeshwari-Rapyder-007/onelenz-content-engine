...
setup_logging("email-connector")
logger = get_logger(__name__)

app = FastAPI(
    title="OneLenz Email Connector",
    description="M365 email connectivity, OAuth, sync management",
    version="1.0.0",
)
...
app.add_middleware(RequestLoggingMiddleware, service_name="email-connector")
...
async def health_check():
    return {"status": "ok", "service": "email-connector"}
